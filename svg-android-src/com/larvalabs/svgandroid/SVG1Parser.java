...
public class SVG1Parser {
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromInputStream(InputStream svgData) throws SVG1ParseException {
        return SVG1Parser.parse(svgData, 0, 0, false);
    }
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromString(String svgData) throws SVG1ParseException {
        return SVG1Parser.parse(new ByteArrayInputStream(svgData.getBytes()), 0, 0, false);
    }
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromResource(Resources resources, int resId) throws SVG1ParseException {
        return SVG1Parser.parse(resources.openRawResource(resId), 0, 0, false);
    }
     ...
     */
    public static SVG1 getSVGFromAsset(AssetManager assetMngr, String svgPath) throws SVG1ParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
        SVG1 svg = getSVGFromInputStream(inputStream);
        inputStream.close();
        return svg;
    }
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromInputStream(InputStream svgData, int searchColor, int replaceColor) throws SVG1ParseException {
        return SVG1Parser.parse(svgData, searchColor, replaceColor, false);
    }
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromString(String svgData, int searchColor, int replaceColor) throws SVG1ParseException {
        return SVG1Parser.parse(new ByteArrayInputStream(svgData.getBytes()), searchColor, replaceColor, false);
    }
     ...
     * @throws SVG1ParseException if there is an error while parsing.
     */
    public static SVG1 getSVGFromResource(Resources resources, int resId, int searchColor, int replaceColor) throws SVG1ParseException {
        return SVG1Parser.parse(resources.openRawResource(resId), searchColor, replaceColor, false);
    }
     ...
     * @throws IOException       if there was a problem reading the file.
     */
    public static SVG1 getSVGFromAsset(AssetManager assetMngr, String svgPath, int searchColor, int replaceColor) throws SVG1ParseException, IOException {
        InputStream inputStream = assetMngr.open(svgPath);
        SVG1 svg = getSVGFromInputStream(inputStream, searchColor, replaceColor);
        inputStream.close();
        return svg;
    }
    ...
    private static SVG1 parse(InputStream in, Integer searchColor, Integer replaceColor, boolean whiteMode) throws SVG1ParseException {
...
//        Util.debug("Parsing complete in " + (System.currentTimeMillis() - start) + " millis.");
            SVG1 result = new SVG1(picture, handler.bounds);
            ...
            throw new SVG1ParseException(e);
        }
    }
    ...
    private static Path doPath(String s) {
        int n = s.length();
        ParserHelper1 ph = new ParserHelper1(s, 0);
        ph.skipWhitespace();
        Path p = new Path();
        float lastX = 0;
        float lastY = 0;
